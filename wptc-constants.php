...
class WPTC_Constants{
	...
	public function production_mode(){
		$this->define( 'WPTC_CRSERVER_URL', 'https://cron.examplewptc.com' );
		$this->define( 'WPTC_USER_SERVICE_URL', 'https://service.examplewptc.com/service.php' );
		$this->define( 'WPTC_APSERVER_URL', 'https://service.examplewptc.com' );
		$this->define( 'WPTC_APSERVER_URL_FORGET', 'https://service.examplewptc.com/?show_forgot_pwd=true' );
		$this->define( 'WPTC_APSERVER_URL_SIGNUP', 'https://service.examplewptc.com/signup' );
		$this->define( 'WPTC_G_DRIVE_AUTHORIZE_URL', 'https://examplewptc.com/gdrive_auth/production/index.php' );
		$this->define( 'WPTC_DROPBOX_REDIRECT_URL', 'https://examplewptc.com/dropbox_auth/index.php' );
		$this->define( 'WPTC_DROPBOX_CLIENT_ID', base64_decode('WPTC_KEY_WPTC_DROPBOX_CLIENT_ID') );
		$this->define( 'WPTC_DROPBOX_CLIENT_SECRET', base64_decode('WPTC_KEY_WPTC_DROPBOX_CLIENT_SECRET') );
	...
	public function staging_mode(){
		...
		$this->define( 'WPTC_APSERVER_URL_FORGET', 'https://service.examplewptc.com/?show_forgot_pwd=true' );
		$this->define( 'WPTC_APSERVER_URL_SIGNUP', 'https://service.examplewptc.com/signup' );
		$this->define( 'WPTC_G_DRIVE_AUTHORIZE_URL', 'https://examplewptc.com/gdrive_auth/staging/index.php' );
		$this->define( 'WPTC_DROPBOX_REDIRECT_URL', 'https://examplewptc.com/dropbox_auth/index.php' );
		$this->define( 'WPTC_DROPBOX_CLIENT_ID', base64_decode('WPTC_KEY_WPTC_DROPBOX_CLIENT_ID') );
		$this->define( 'WPTC_DROPBOX_CLIENT_SECRET', base64_decode('WPTC_KEY_WPTC_DROPBOX_CLIENT_SECRET') );
		$this->define( 'WPTC_CURL_TIMEOUT', 20 );
	...
	public function development_mode(){
		...
		$this->define( 'WPTC_APSERVER_URL_FORGET', 'https://service.examplewptc.com/?show_forgot_pwd=true' );
		$this->define( 'WPTC_APSERVER_URL_SIGNUP', 'https://service.examplewptc.com/signup' );
		$this->define( 'WPTC_G_DRIVE_AUTHORIZE_URL', 'https://examplewptc.com/gdrive_auth/development/index.php');
		$this->define( 'WPTC_DROPBOX_REDIRECT_URL', 'https://examplewptc.com/dropbox_auth/index.php' );
		$this->define( 'WPTC_DROPBOX_CLIENT_ID', base64_decode('WPTC_KEY_WPTC_DROPBOX_CLIENT_ID') );
		$this->define( 'WPTC_DROPBOX_CLIENT_SECRET', base64_decode('WPTC_KEY_WPTC_DROPBOX_CLIENT_SECRET') );
		$this->define( 'WPTC_CURL_TIMEOUT', 20 );
