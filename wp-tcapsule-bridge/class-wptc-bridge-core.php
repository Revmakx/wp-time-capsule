	...
	<div class="container" style="padding:10%">
		...
		<div class="row" style="position: relative;padding: 1rem;margin: 1rem -15px;border: 1px solid #e5e5e5;background-color: #fff;">
			<div class="col-sm-12" style="text-align: center; padding: 15px">
				...
				<div style="font-size: 13px;padding: 15px;"><a target="_blank" href="http://docs.examplewptc.com/article/31-how-to-restore-your-site-if-the-database-is-deleted">Where do I get meta file?</a></div>
