...
class Wptc_Backup_Before_Update extends WPTC_Privileges {
	...
	private function get_server_not_writable_arr(){
		return array(
			'error' => 'Failed, Server is not writable, please <a target="_blank" href="http://docs.examplewptc.com/article/24-why-does-plugins-themes-fail-to-update">add FTP details</a>',
		);
	}
