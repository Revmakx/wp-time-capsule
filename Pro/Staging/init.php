...
class Wptc_Staging extends WPTC_Privileges {
	...
	public function get_staging_current_status_key(){
		...
		$know_more_link = '<a href="http://docs.examplewptc.com/article/35-how-to-fix-internal-staging-failures" target="_blank">How to fix</a>';
		switch ($current_status) {
			...
			case 'copy_files_over':
				...
				break;
			default:
				$msg = 'Unknown error, email us at <a href="mailto:help@examplewptc.com?Subject=Contact" target="_top">help@examplewptc.com</a> ';
				break;
		}
