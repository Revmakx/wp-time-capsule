	...
	public function page_settings_content($more_tables_div, $dets1 = null, $dets2 = null, $dets3 = null) {
		...
		<div class="table ui-tabs-hide" id="wp-time-capsule-tab-staging" style="padding-top: 20px;">
			...
			<table class="form-table">
				<tr>
					<th scope="row">Include/Exclude Content (<a href="https://docs.examplewptc.com/article/43-how-to-include-exclude-files-in-creating-or-copying-staging-site" target="_blank" style="text-decoration: underline;">Need Help?</a>)</th>
					<td >
