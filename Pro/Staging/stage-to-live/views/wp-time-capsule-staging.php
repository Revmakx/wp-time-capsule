...
if(!$stage_to_live->is_allowed_to_copy_site_to_live()){?>
	"Staging to Live" feature is not active on your account. <span> Please email us at <a href="mailto:help@examplewptc.com?Subject=Contact" target="_top">help@examplewptc.com</a> for further assistance.</span>.<br>
	<?php
	return ;
}
...
<div id="dashboard_activity" class="staging_area_wptc" >
	<h4>Include/Exclude Content ( <a href="https://docs.examplewptc.com/article/28-how-push-staging-site-to-production" style="text-decoration: underline;">Need Help?</a> )</h4>
