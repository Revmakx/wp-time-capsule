...
class WPTC_GdriveFacade {
	const PRODUCTION_CLIENT_ID = 'WPTC_KEY_PRODUCTION_CLIENT_ID';
	const PRODUCTION_SECRET_KEY = 'WPTC_KEY_PRODUCTION_SECRET_KEY';
	const STAGING_CLIENT_ID = 'WPTC_KEY_STAGING_CLIENT_ID';
	const STAGING_SECRET_KEY = 'WPTC_KEY_STAGING_SECRET_KEY';
	const DEVELOPMENT_CLIENT_ID = 'WPTC_KEY_DEVELOPMENT_CLIENT_ID';
	const DEVELOPMENT_SECRET_KEY = 'WPTC_KEY_DEVELOPMENT_SECRET_KEY';
	const RETRY_COUNT = 3;
