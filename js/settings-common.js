			...
			swal({
				...
				if (dismiss === 'cancel') {
					swal({
						...
						html               : wptc_get_dialog_body('Please read <a target="_blank" href="http://docs.examplewptc.com/article/23-add-new-site-using-existing-google-drive-token">this</a> on how to use the existing authorization token.' , ''),
						padding            : '0px 0px 10px 0',
						buttonsStyling     : false,
						showCancelButton   : false,
						confirmButtonColor : '',
