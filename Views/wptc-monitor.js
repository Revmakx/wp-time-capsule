...
function show_safe_files_limit_dialog_and_clear_timeout_wptc(filesObj) {
	...
	'<div style="line-height: 22px; margin-bottom: 20px;">The following files are not writable. Please change the file permissions or enable FTP for this restore - <a href="http://docs.examplewptc.com/article/10-enable-ftp-file-permissions" target="_blank"> Check how? </a></div>'+
...
function get_failure_data_wptc(request){
	...
	if (content != '') {
		content += '<br><a href="http://docs.examplewptc.com/article/27-what-you-can-do-with-your-wptc-restore-logs" target="_blank">Help?</a> or email us at  <a href="mailto:help@examplewptc.com?Subject=Contact" target="_top">help@examplewptc.com</a>';
	}
...
function wptc_restore_confirmation_pop_up(){
	...
	html_content     += wptc_is_latest_restore_point_click(restore_obj) ? 'We will only restore the database changes in this restore <a href="http://docs.examplewptc.com/article/34-how-does-the-latest-point-restore-in-real-time-works" target="_blank">Know more</a>. ' : '';
