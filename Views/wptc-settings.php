	...
	<form id="wptc-settingsform" action="#" method="post">
				...
				<tr>
					...
					<td>
						<fieldset>
							...
							<p class="description"><?php _e( 'Used for adding bulk sites on the WPTC main dashboard.', 'wp-time-capsule' ); ?><a target="_blank" href="https://docs.examplewptc.com/article/59-how-to-add-multiple-sites-on-wptc">  help?</a></p>
						</fieldset>
					</td>
				</tr>
					...
					<td>
						<fieldset>
							...
							<p class="description">
								...
								<a href="http://docs.examplewptc.com/article/23-add-new-site-using-existing-google-drive-token" style="text-decoration: none" target="_blank"><?php _e('Show me how.', 'wp-time-capsule'); ?></a> </p>
						</fieldset>
					</td>
				</tr>
				<?php } ?>
		...
		<div class="table ui-tabs-hide" id="wp-time-capsule-tab-backup">
			...
			<table class="form-table">
				...
				<tr>
					<th scope="row"><?php _e( 'Include/Exclude Content', 'wp-time-capsule' ); ?> (<a href="https://docs.examplewptc.com/article/32-how-to-exclude-or-include-the-files-from-backup" target="_blank" style="text-decoration: underline;">Need Help?</a>) </th>
						<td >
				...
				<tr>
					<th scope="row">
						<label for="disable_sentry_lib_wptc">
							Manually decrypt a database backup file ( <a href="https://docs.examplewptc.com/article/36-how-to-decrypt-database-backup-file" target="_blank"> Need help? </a> )
						</label>
					</th>
					<td>
