...
Plugin URI: https://examplewptc.com
...
function wptc_cron_status($return = false){
	...
	if ($cron_status['status'] == 'success') {
		...
		$note = "<br> Note: Backup is paused on this site until you make an action <br> If you are not sure what went wrong, please email us at <a href='mailto:help@examplewptc.com?Subject=Contact' target='_top'>help@examplewptc.com</a> </div>";
